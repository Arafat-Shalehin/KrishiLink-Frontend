        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 border border-(--color-border) bg-(--color-surface) text-(--color-text) placeholder:text-(--color-muted) rounded-xl focus:outline-none focus:ring-4 focus:ring-(--color-primary)/20"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full mt-6 py-3 rounded-xl bg-(--color-primary) hover:brightness-95 text-white font-semibold transition disabled:opacity-60 disabled:cursor-not-allowed"
          >
