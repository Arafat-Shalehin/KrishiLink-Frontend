...
//   console.log(location);
  ...
  return (
    <div className="flex justify-center items-center my-10">
      <div className="card w-full max-w-sm shrink-0 shadow-2xl mt-15">
        ...
        <form onSubmit={handleLogin} className="card-body">
          <fieldset className="fieldset relative">
            ...
            <span
              ...
              className="absolute right-[25px] top-[109px] cursor-pointer z-50"
            >
              {show ? (
            ...
            <p className="text-center font-semibold pt-3">
              ...
              <Link className="text-secondary" to="/auth/register" state={location.state}>
                Register
              </Link>
            </p>
          </fieldset>
