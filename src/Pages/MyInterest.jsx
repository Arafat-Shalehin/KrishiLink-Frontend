...
const MyInterest = () => {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      case "accepted":
        return "text-(--color-primary) bg-[color-mix(in_srgb,var(--color-primary)_12%,transparent) border-[color-mix(in_srgb,var(--color-primary)_25%,transparent)";
      case "rejected":
              ...
              {interests.length === 0 ? (
                ...
                interests.map((interest) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-(--color-text)/90 italic">
                      {interest.message || "—"}
                    </td>
